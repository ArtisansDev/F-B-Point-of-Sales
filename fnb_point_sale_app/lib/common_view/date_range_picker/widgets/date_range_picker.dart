...
Widget kDayTileBuilder(
  ...
  return
    Container(
      margin: EdgeInsets.only(bottom: 0.15.h,top:  0.15.h),
      child:  DayTileWidget(
        size: theme.tileSize,
...
class DateRangePickerWidget extends StatefulWidget {
  ...
  final DateRangeModel? initialDateRange;
...
class DateRangePickerWidgetState extends State<DateRangePickerWidget> {
  ...
  Widget build(BuildContext context) {
              ...
              if (widget.doubleMonth) ...{
                if (widget.displayMonthsSeparator)
                  VerticalDivider(
                    ...
                    color: ColorConstants.cAppTaxColour.withOpacity(0.07),
                  ),
                EnrichedMonthWrapWidget(
                  theme: widget.theme,
                  onDateChanged: calendarController.onDateChanged,
    ...
    return Container(
      color: ColorConstants.cAppTaxColour.withOpacity(0.05),
