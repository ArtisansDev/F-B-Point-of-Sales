...
class RangePickerController {
  ...
  DateRangeModel? get dateRange {
    ...
    return DateRangeModel(startDate!, endDate!);
  }
  ...
  void onDateChanged(DateTime date) {
    if (startDate == null) {
      startDate = date;
      onDateRangeChanged(DateRangeModel(startDate!, startDate!));
      ...
      if (date.isBefore(startDate!)) {
        ...
        endDate = date;
        onDateRangeChanged(DateRangeModel(startDate!, endDate!));
      }
    } else {
      startDate = date;
      endDate = null;
  ...
  void onDateRangeChangedExternally(DateRangeModel? newRange) {
...
class CalendarWidgetController {
  ...
  void setDateRange(DateRangeModel? dateRange) {
    _streamController.add(null);
