...
import 'package:fnb_point_sale_app/model/pay_now/view/pay_now_order_list.dart';
...
class PayNowOrderScreen extends GetView<PayNowController> {
  const PayNowOrderScreen({super.key});
