...
import '../controller/credit_card_view_controller.dart';

///partha paul
///debit_card_view
///10/02/25

class CreditCardView extends GetView<CreditCardViewController> {
  final Function onPayment;

  const CreditCardView({super.key, required this.onPayment});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreditCardViewController(onPayment));
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: TextInputWidget(
                          placeHolder: 'Enter the last 4 digits credit card number',
                          //sEnterName.tr,
                          controller: controller.nameController.value,
                          errorText: null,
                          textInputType: TextInputType.emailAddress,
                          hintText: 'Enter the last 4 digits credit card number',
                          //sEnterName.tr,
