                      ...
                      Expanded(
                        child: Container(
                            ...
                            child: TextInputWidget(
                              ...
                              controller:
                                  controller.sSelectDateRangeController.value,
                              errorText: null,
                              textInputType: TextInputType.emailAddress,
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                              ...
                              padding: EdgeInsets.all(9.5.sp),
                              decoration:  BoxDecoration(
                                color: controller.selectType.value == sDine_In.tr
                                    ? ColorConstants.cAppButtonColour
                                    : ColorConstants.primaryBackgroundColor,
                              ),
                              alignment: Alignment.center,
                              child: Text(
                                ...
                                style: getText500(size: 11.sp,
                                    colors:  controller.selectType.value == sDine_In.tr
                                        ? ColorConstants.white
                                        : ColorConstants.cAppTaxColour),
                              )),
                        ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                              ...
                              padding: EdgeInsets.all(9.5.sp),
                              decoration: BoxDecoration(
                                color: controller.selectType.value == sTake_Away.tr
                                    ? ColorConstants.cAppButtonColour
                                    : ColorConstants.primaryBackgroundColor,
                                borderRadius: BorderRadius.only(
                              ...
                              child: Text(
                                sTake_Away.tr,
                                style: getText500(size: 11.sp,
                                    colors:  controller.selectType.value == sTake_Away.tr
                                        ? ColorConstants.white
                                        : ColorConstants.cAppTaxColour),
                              )),
                        ),
