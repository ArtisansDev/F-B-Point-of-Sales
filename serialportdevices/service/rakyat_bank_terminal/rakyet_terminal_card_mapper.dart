...
// === Create custom number to support Wallet & Union Pay of Rakyet terminal == //
// 20 - WALLET
// 21 - UNION_PAY

//== Rakyet Terminal Cart Type Response ==//
...
/// We need to create mapper to convert Rakyet terminal response to mbb terminal response.
/// Because, mbb terminal key is being used in payment types to link to exact payment type.
String getPaymentCardFromRakyetCode(String? cardType) {
