...
import 'data/remote/api_call/balance/balance_api.dart';
import 'data/remote/api_call/balance/balance_api_impl.dart';
...
void setupLocator() {
  ...
  locator.registerLazySingleton<BalanceApi>(() => BalanceApiImpl());
