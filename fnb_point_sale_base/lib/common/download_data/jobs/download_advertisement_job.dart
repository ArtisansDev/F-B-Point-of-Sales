...
Future<void> downloadProductCategoryList(Function onError) async {
  try {
    ///api product call
    ...
    await NetworkUtils().checkInternetConnection().then((
      ...
      if (isInternetAvailable) {
        ...
        await productApiImpl.postGetAllCategory(mProductRequest);
        if (mWebResponseSuccess.statusCode == WebConstants.statusCode200) {
          ...
          await localAllCategoryApi
              .saveAllCategoryResponse(mGetAllCategoryResponse);
        } else {
    ...
    MyLogUtils.logDebug(
        '_downloadProductCategoryList failed with exception $e');
    onError('_downloadProductCategoryList failed with exception $e');
  }
}
