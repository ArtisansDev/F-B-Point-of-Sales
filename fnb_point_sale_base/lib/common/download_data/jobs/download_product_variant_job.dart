...
Future<void> downloadProductVariantList(Function onError) async {
  try {
    ///api product call
    ...
    await NetworkUtils()
      ...
      if (isInternetAvailable) {
        ...
        WebResponseSuccess mWebResponseSuccess =
            await productApiImpl.postGetAllVariant(mProductRequest);
        if (mWebResponseSuccess.statusCode == WebConstants.statusCode200) {
          GetAllVariantResponse mGetAllVariantResponse =
              mWebResponseSuccess.data;
          var localModifierSave = locator.get<VariantLocalApi>();
          await localModifierSave.save(mGetAllVariantResponse);
        } else {
