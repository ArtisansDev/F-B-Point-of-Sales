class AppUtilConstants{
  ...
  static const String patternOnlyNumberTime = "[0-9:]";
  static const String patternDecimalNumber = r'^([0-9]+(\.?[0-9]?[0-9]?)?)';
  static const String patternDecimalNumberWeight = r'^([0-9]+(\.?[0-9]?[0-9]?)?)';
  ...
  static const String patternStringAndSpaceDot = "[a-zA-Z. ]";
