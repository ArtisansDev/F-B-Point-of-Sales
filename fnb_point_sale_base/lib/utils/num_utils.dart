...
String getReadableAmountCurrency(String currency, dynamic amount) {
  String readableAmount = getOnlyReadableAmount(amount);
  if (readableAmount == "-0.00") {
    return "$currency 0.00";
  }
...
double getTruncateToDecimalPlaces(num value, int fractionalDigits) {
  return (value * pow(10, fractionalDigits)).truncate() /
      pow(10, fractionalDigits);
}

bool hasOnlyNumbers(String input) {
