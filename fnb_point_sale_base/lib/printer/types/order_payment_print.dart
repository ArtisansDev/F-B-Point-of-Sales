              ...
              pw.Expanded(
                  ...
                  child: pw.Container(
                    ...
                    child: pw.Align(
                      alignment: pw.Alignment.centerLeft,
                      child: pw.Text(
                          "${sCustomerName.tr}:-", style: getNormalTextStyle()),
                    ),
                  )),
              pw.Expanded(
                  flex: 3,
              ...
              pw.Expanded(
                  ...
                  child: pw.Container(
                    ...
                    child: pw.Align(
                      alignment: pw.Alignment.centerLeft,
                      child: pw.Text(
                          "${sPhoneNumber.tr}:-", style: getNormalTextStyle()),
                    ),
                  )),
              pw.Expanded(
                  flex: 3,
    ...
    pw.Expanded(
        ...
        child: pw.Container(
          ...
          child: pw.Align(
            alignment: pw.Alignment.centerRight,
            child: pw.Text(
                '$currencyData ${(roundToNearestPossible(getDoubleValue(
    ...
    pw.Expanded(
        ...
        child: pw.Container(
          ...
          child: pw.Align(
            alignment: pw.Alignment.centerRight,
            child: pw.Text(
                '$currencyData ${getDoubleValue(roundToNearestPossible(
                    getDoubleValue(getDoubleValue(mOrderDetailList.totalAmount)
