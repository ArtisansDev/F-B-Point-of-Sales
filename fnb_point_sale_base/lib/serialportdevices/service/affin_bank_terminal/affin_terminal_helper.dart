...
List<int> constructPresentationHeaderRakyat(
...
List<int> createPresentationHeaderRakyat({String transactionCode = '00',String responseCode = '00'}) {
  // Example usage:
  String formatVersion = '1';
  String requestResponseIndicator = '0';
  bool moreToFollow = false;
  List<int> presentationHeader = constructPresentationHeaderRakyat(formatVersion,
